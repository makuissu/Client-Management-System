...
<html>
<head>
<title>SYSTEME DE GESTION DE LA CLIENTELE ||Page d'accueil</title>
...
WHERE DATE(PostingDate) = CURDATE() - INTERVAL 1 DAY";

$query7 = $dbh->prepare($sql7);
$query7->execute();
$yest_sale = $query7->fetch(PDO::FETCH_COLUMN);
