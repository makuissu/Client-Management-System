			...
			<div class="inner-content">
				...
				<div class="outter-wp">
					...
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two">Rapport de ventes </h3>
						<div class="graph">
							<div class="tables">
								 <?php
...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">Rapport de vente par mois</h4>
<h4 align="center" style="color:blue">Rapport de ventes de <?php echo $m1."-".$y1;?> au <?php echo $m2."-".$y2;?></h4>
<hr />
...
{               ?>
									     <tr class="active">
									      <th scope="row"><?php echo htmlentities($cnt);?></th>
									       ...
									       <td><?php  echo $total=$row->totalprice ." Fcfa"?></td>
...
$y2=date("Y",$year2);
 ?>
 <h4 class="header-title m-t-0 m-b-30">Rapport de vente par an</h4>
    <h4 align="center" style="color:blue">Rapport de vente de <?php echo $y1;?> au <?php echo $y2;?></h4>
    <hr /> 
    <table class="table" border="1"> <thead> <tr>  
									<th>S.NO</th>
<th>Mois/ Annee </th>
