...
$query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("La facture a ete cree avec succes. Le numero de facture est "+"'.$invoiceid.'")</script>';
echo "<script>window.location.href ='invoices.php'</script>";
  }
  else
    {
         echo '<script>alert("Quelque s est mal passe. Reesayer encore")</script>';
    }
    }
}
  	?>
...
<html>
<head>
	<title>SYSTEME DE GESTION DE L CLIENTELE|| Attribuer des services </title>
				...
				<div class="outter-wp">
					...
					<div class="sub-heard-part">
						<ol class="breadcrumb m-b-0">
							...
							<li class="active">Attribuer des services</li>
						</ol>
					</div>
					<!--//sub-heard-part-->
					<div class="graph-visual tables-main">
						...
						<h3 class="inner-tittle two"> Attribuer des services</h3>
						<div class="graph">
							<div class="tables">
								<form method="post">
