...
<head>
    <title> Gestion de la clientele <legend></legend> || Page d'accueil</title>
    ...
    <link rel="stylesheet" href="...images/logs.png">
    <!-- //Custom Theme files -->
    <!-- online-fonts -->
        ...
        <div class="row">
            ...
            <div class="col-lg-2" id="spy">
                ...
                <ul class="nav nav-pills flex-column mt-lg-5">
                    <li class="nav-item"><a class="nav-link active" href="index.php">Page d'accueil</a></li>
            ...
            <div class="col-lg-10 scrollspy-example pr-0" data-spy="scroll" data-target="#spy">
                ...
                <div id="home" class="w3ls-banner d-flex  align-items-center justify-content-center">
                    <div class="bnr-w3pvt text-center">
                        <h4>Bienvenue!!</h4>
                        <h2 class="bnr-txt-w3"> Gestion de la clientele de 2N CORPORATE SARL</h2>
                    ...
                    <div class="section">
                        ...
                        <div class="footer-bottom py-lg-5 py-3">
                            ...
                            <div class="footer-copy text-center">
                                <p class="text-dark">Systeme de Gestion de la Clientele @ 2024
