...
<body>
	<div class="error_page">
		...
		<div class="error-top">
			<h2 class="inner-tittle page"> SGC Clients</h2>
			<div class="login">
				
				<div class="buttons login">
					<h3 class="inner-tittle t-inner" style="color: lightblue">Se connecter</h3>
				</div>
				<form id="login" method="post" name="login"> 
					...
					<div class="new">
						...
						<p><a href="../index.php">Rentrer a l'accueil!!</a></p>
						<div class="clearfix"></div>
					</div>
				</form>
			</div>
